<?php
/**
 * Icon utility functions for OBX Blocks
 *
 * @package OBX_Blocks
 */

if (!function_exists('obx_get_icon_svg')) {
    /**
     * Get SVG icon markup
     *
     ...
     */
    function obx_get_icon_svg($icon) {
        // If the icon is already an SVG string, return it
        ...
        // Return the icon if it exists, otherwise return empty string
